...
do
	echo ""
tput setaf 3
read -p "𝑷𝒍𝒆𝒂𝒔𝒆 𝒆𝒏𝒕𝒆𝒓 𝒚𝒐𝒖𝒓 𝑵𝒂𝒎𝒆😊:" PROC
tput sgr 0
if [[ ${#PROC} -gt 8 ]]; then
	echo -e "\e[1;34m[*] \033[32m𝐓𝐨𝐨 𝐥𝐨𝐧𝐠  𝐜𝐡𝐚𝐫𝐚𝐜𝐭𝐞𝐫𝐬 𝐘𝐨𝐮 𝐡𝐚𝐯𝐞 𝐢𝐧𝐩𝐮𝐭...\033[0m"
	echo ""
	echo -e "\033[32m𝐏𝐥𝐞𝐚𝐬𝐞 𝐞𝐧𝐭𝐞𝐫 𝐥𝐞𝐬𝐬 𝐭𝐡𝐚𝐧 \033[33m9 \033[32m𝐂𝐡𝐚𝐫𝐚𝐜𝐭𝐞𝐫𝐬 𝐍𝐚𝐦𝐞\033[0m" | pv -qL 10;
	echo ""
	sleep 4
	clear
echo -e "\033[01;32m
